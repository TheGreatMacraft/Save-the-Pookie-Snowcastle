...
public class BuildingDefenses : MonoBehaviour
{
    ...
    private ContactFilter2D hollogramCollisionFilter = new ContactFilter2D();
    private Collider2D[] hollogramCollisionResults = new Collider2D[10];
    ...
    {
        return objectHologram.GetComponent<Collider2D>().OverlapCollider(hollogramCollisionFilter, hollogramCollisionResults) > 0;
    }
